...
const ProjectSection = forwardRef(function ProjectSection(props, ref) {
    ...
    //   }, []);
    const projectData = [
        { title: '광주컨트리클럽',img:'golf', contribute: '100%', period: '3 weeks', useStack: 'HTML5, CSS3, JavsScript', code: 'https://github.com/kyuleee/golf', view: 'https://kyuleee.github.io/golf/', review: '힘듦..', gif: '' },
        { title: '경복궁 별빛야행',img:'palace', contribute: '40%', period: '4 weeks', useStack: 'HTML5, CSS3, node.js, react', code: 'https://github.com/kyuleee/Gyeongbokgung-Starlight-Tour', view: 'https://kyuleee.github.io/Gyeongbokgung-Starlight-Tour/', review: '팀플망해라', gif: '' },
        { title: '프론트엔드 사전',img:'dict', contribute: '100%', period: '3days', useStack: 'HTML5, CSS3, node.js, react', code: 'https://github.com/kyuleee/dictionary', view: 'https://kyuleee.github.io/dictionary/', review: '뭐가 뭔지 1도 모름', gif: '' },
        { title: '독:수리',img:'dict', contribute: '40%', period: '4 weeks', useStack: 'HTML5, CSS3, node.js, react', code: 'https://github.com/kyuleee/docsuri', view: 'https://kyuleee.github.io/docsuri/', review: '독수리수리수리마수리', gif: '' }
    ];
