...
const ProjectSection = forwardRef(function ProjectSection(props, ref) {
    ...
    const projectData = [
        { title: '광주컨트리클럽',img:'golf', contribute: '100%(개인)', period: '4 weeks', useStack: 'HTML5, CSS3, JavsScript', code: 'https://github.com/kyuleee/golf', view: 'https://kyuleee.github.io/golf/', review: '기존 광주 컨트리클럽 웹사이트의 디자인과 더불어 웹사이트의 콘텐츠, 사용자 경험, 반응형 작업을 개선하려 진행한 개인 프로젝트입니다.<br/> 웹 사이트의 시각 및 감성적인 요소는 다른 필수적인 세부 사항을 고려하기에 앞서 먼저 결정했습니다. 시각적 언어가 전반적인 브랜드 아이덴티티와 일치해야 되기 때문에 로고, 브랜드 색상 및 웹사이트 색 구성 표가 추구하는 새로운 스타일에 적합한지 고민하면서 개발했습니다. 골프 사이트의 가장 핵심적인 부분을 시작으로 정해진 순서에 맞춰 사이트 요소를 하나씩 살펴볼 수 있도록 유도했습니다.', gif: '' },
        ...
        { title: '프론트엔드 사전',img:'dict', contribute: '100%(개인)', period: '3 days', useStack: 'HTML5, CSS3, node.js, react', code: 'https://github.com/kyuleee/dictionary', view: 'https://kyuleee.github.io/dictionary/', review: 'Search 기능, Remove 기능, Edit 기능, Create 기능이 되는 사전을 react를 사용하여 프론트엔드 사전을 만들었습니다. <br/>함수 컴포넌트를 사용하여 직관적인 코드를 작성할 수 있었고 메모리 자원을 적게 사용할 수 있었습니다. 또한 Hook의 useState를 사용하여 state를 관리할 수 있고, useEffect, useReducer, createContext, useCallback, useRef 등울 사용하여 컴포넌트에서 다양한 기능을 경험했습니다. ', gif: '' },
